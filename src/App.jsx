      ...
      <div className=" px-4 pt-4 md:px-12 md:pt-12 max-w-[1350px] mx-auto relative">
        ...
        <main>
          ...
          <section id="about" className=" flex gap-11 max-h-max flex-col lg:flex-row mb-16">
            <div className="bg-black p-6 md:p-16 rounded-lg border-2 flex flex-col gap-6 lg:flex-[2.1]">
              <h2 className="title-big font-semibold text-white">{t('about.title')}</h2>
            ...
            <div className="bg-white rounded-lg border-2 p-6 md:p-16 flex flex-col justify-end items-start lg:flex-[1] gap-3">
              ...
              <h2 className="title-small font-semibold">{t('about.help.title')}</h2>
            ...
            <div className="lg:w-1/2">
              <AccordionItem title={t('modules.retail.title')}>
                <div className="flex justify-start gap-1">
                  <span>ICON</span>
                  <h3 className="title-small font-semibold">{t('modules.retail.what') ? t('modules.retail.title') + ': ' : t('modules.retail.title')}</h3>
                </div>
                <p className="descriptions mb-4">{t('modules.retail.what')}</p>

                <div className="flex justify-start gap-1">
                  <span>ICON</span>
                  <h3 className="title-small font-semibold">{t('modules.retail.title') ? t('modules.retail.title') : '—'}</h3>
                </div>
                <p className="descriptions mb-4">{t('modules.retail.alerts')}</p>

                <div className="flex justify-start gap-1">
                  <span>ICON</span>
                  <h3 className="title-small font-semibold">Impacto:</h3>
                </div>
                <p className="descriptions mb-4">{t('modules.retail.impact')}</p>
              </AccordionItem>

              <AccordionItem title={t('modules.face.title')}>
                <div className="flex justify-start gap-1">
                  <span>ICON</span>
                  <h3 className="title-small font-semibold">{t('modules.face.title')}:</h3>
                </div>
                <p className="descriptions mb-4">{t('modules.face.what')}</p>
              ...
              <AccordionItem title={t('modules.perimeter.title')}>
                <div className="flex justify-start gap-1">
                  <span>ICON</span>
                  <h3 className="title-small font-semibold">{t('modules.perimeter.title')}:</h3>
                </div>
                <p className="descriptions mb-4">{t('modules.perimeter.what')}</p>
              </AccordionItem>

              <AccordionItem title={t('modules.loitering.title')}>
                <div className="flex justify-start gap-1">
                  <span>ICON</span>
                  <h3 className="title-small font-semibold">{t('modules.loitering.title')}:</h3>
                </div>
                <p className="descriptions mb-4">{t('modules.loitering.what')}</p>
              </AccordionItem>

              <AccordionItem title={t('modules.lpr.title')}>
                <div className="flex justify-start gap-1">
                  <span>ICON</span>
                  <h3 className="title-small font-semibold">{t('modules.lpr.title')}:</h3>
                </div>
                <p className="descriptions mb-4">{t('modules.lpr.what')}</p>
              </AccordionItem>
            </div>
          </section>
          ...
          <section id="features" className="space-y-11 mb-16">
            <div className="flex flex-col ml-6 md:ml-16 box-border md:w-[443px] ">
              <h2 className="title-big font-semibold mb-4">{t('features.title')}</h2>
              <span className="descriptions mb-6">{t('metrics.desc')}</span>
            ...
            <div className="grid grid-cols-1 grid-rows-1 gap-y-8 md:grid-cols-2 md:grid-rows-3 md:gap-y-12 md:gap-x-12 
              ...
              <div className=" w-full lg:min-w-80 lg:h-48 md:min-w-72 md:h-48 bg-white rounded-lg border-green-700 border-2 ">
                ...
                <h3 className="title-smaller px-7 pb-7 w-4/5">{t('features.step1')}</h3>
              </div>
              ...
              <div className=" w-full lg:min-w-80 lg:h-48 md:min-w-72 md:h-48 bg-white rounded-lg border-green-700 border-2 ">
                ...
                <h3 className="title-smaller px-7 pb-7 w-4/5">{t('features.step2')}</h3>
              </div>
              ...
              <div className=" w-full lg:min-w-80 lg:h-48 md:min-w-72 md:h-48 bg-white rounded-lg border-green-700 border-2 ">
                ...
                <h3 className="title-smaller px-7 pb-7 w-4/5">{t('features.step3')}</h3>
              </div>
              ...
              <div className=" w-full lg:min-w-80 lg:h-48 md:min-w-72 md:h-48 bg-white rounded-lg border-green-700 border-2 ">
                ...
                <h3 className="title-smaller px-7 pb-7 w-4/5">{t('features.step4')}</h3>
              </div>
              ...
              <div className=" w-full lg:min-w-80 lg:h-48 md:min-w-72 md:h-48 bg-white rounded-lg border-green-700 border-2 ">
                ...
                <h3 className="title-smaller px-7 pb-7 w-4/5">{t('features.step5')}</h3>
              </div>
              ...
              <div className=" w-full lg:min-w-80 lg:h-48 md:min-w-72 md:h-48 bg-white rounded-lg border-green-700 border-2 ">
                ...
                <h3 className="title-smaller px-7 pb-7 w-4/5">{t('features.step6')}</h3>
              </div>
            </div>
          </section>
          ...
          <section id="benefits" className=" bg-black rounded-lg mb-16">
            <div className="flex flex-col mx-6 md:ml-16 pt-6 md:pt-16 md:w-[443px] ">
              ...
              <span className="descriptions text-white mb-6">{t('metrics.desc')}</span>
            ...
            <div className="grid grid-cols-1 grid-rows-8 md:grid-cols-2 md:grid-rows-4 px-6 md:px-16 pb-16 mx-auto gap-4">
              <div className="bg-green-500 min-h-[200px] lg:min-h-[288px] flex flex-col justify-end rounded-lg">
                ...
                <h3 className="title-small p-7 w-4/5">{t('benefits.1')}</h3>
              </div>
              <div className="bg-green-500 min-h-[200px] lg:min-h-[288px] flex flex-col justify-end rounded-lg">
                <span className="px-7">2</span>
                <h3 className="title-small p-7 w-4/5">{t('benefits.2')}</h3>
              </div>
              <div className="bg-green-500 min-h-[200px] lg:min-h-[288px] flex flex-col justify-end rounded-lg">
                <span className="px-7">3</span>
                <h3 className="title-small p-7 w-4/5">{t('benefits.3')}</h3>
              </div>
              <div className="bg-green-500 min-h-[200px] lg:min-h-[288px] flex flex-col justify-end rounded-lg">
                <span className="px-7">4</span>
                <h3 className="title-small p-7 w-4/5">{t('benefits.4')}</h3>
              </div>
              <div className="bg-green-500 min-h-[200px] lg:min-h-[288px] flex flex-col justify-end rounded-lg">
                <span className="px-7">5</span>
                <h3 className="title-small p-7 w-4/5">{t('benefits.5')}</h3>
              </div>
              <div className="bg-green-500 min-h-[200px] lg:min-h-[288px] flex flex-col justify-end rounded-lg">
                <span className="px-7">6</span>
                <h3 className="title-small p-7 w-4/5">{t('benefits.6')}</h3>
              </div>
              <div className="bg-green-500 min-h-[200px] lg:min-h-[288px] flex flex-col justify-end rounded-lg">
                <span className="px-7">7</span>
                <h3 className="title-small p-7 w-4/5">{t('benefits.7')}</h3>
              </div>
              <div className="bg-green-500 min-h-[200px] lg:min-h-[288px] flex flex-col justify-end rounded-lg">
                <span className="px-7">8</span>
                <h3 className="title-small p-7 w-4/5">{t('benefits.8')}</h3>
              </div>
            </div>
          </section>
          ...
          <section className="bg-white flex flex-col items-center mb-16 rounded-lg p-6 md:p-16">
            ...
            <div>
              <table className="border-separate border-spacing-0 rounded-lg bg-black table-fixed">
                ...
                <tbody>
                  <tr>
                    <td className="bg-white border-2 border-black rounded-lg border-t-0 descriptions font-semibold">{t('versions.option1')}</td>
                  ...
                  <tr>
                    <td className="bg-white border-2 border-black rounded-lg border-t-0 descriptions font-semibold">{t('versions.option2')}</td>
                  ...
                  <tr>
                    <td className=" bg-white border-2 border-black rounded-lg border-t-0 descriptions font-semibold">{t('versions.option3')}</td>
          ...
          <section className="flex flex-col-reverse gap-20 lg:flex-row lg:justify-between p-6 md:p-16 rounded-lg bg-black mb-16">
            <div className="lg:w-1/2">
              <AccordionItem title={t('modules.retail.title')} titleTextColor="text-white" buttonColor="text-white">
                <div className="flex justify-start gap-1">
                  <span className="text-white">ICON</span>
                  <h3 className="title-small text-white font-bold">{t('modules.retail.title')}:</h3>
                </div>
                <p className="descriptions text-white mb-4">{t('modules.retail.what')}</p>

                <div className="flex justify-start gap-1">
                  <span className="text-white">ICON</span>
                  <h3 className="title-small text-white font-bold">Alertas Típicas:</h3>
                </div>
                <p className="descriptions text-white mb-4">{t('modules.retail.alerts')}</p>

                <div className="flex justify-start gap-1">
                  <span className="text-white">ICON</span>
                  <h3 className="title-small text-white font-bold">Impacto:</h3>
                </div>
                <p className="descriptions text-white mb-4">{t('modules.retail.impact')}</p>
              </AccordionItem>

              <AccordionItem title={t('modules.face.title')} titleTextColor="text-white" buttonColor="text-white">
                <p className="descriptions text-white">{t('modules.face.what')}</p>
              </AccordionItem>

              <AccordionItem title={t('modules.perimeter.title')} titleTextColor="text-white" buttonColor="text-white">
                <p className="descriptions text-white">{t('modules.perimeter.what')}</p>
              </AccordionItem>

              <AccordionItem title={t('modules.loitering.title')} titleTextColor="text-white" buttonColor="text-white">
                <p className="descriptions text-white">{t('modules.loitering.what')}</p>
              </AccordionItem>

              <AccordionItem title={t('modules.lpr.title')} titleTextColor="text-white" buttonColor="text-white">
                <p className="descriptions text-white">{t('modules.lpr.what')}</p>
              </AccordionItem>
            </div>

            <div className="flex flex-col lg:1/2">
              <h2 className="title-big text-white font-semibold mb-4">{t('industries.title')}</h2>
              <p className="descriptions text-white mb-6">{t('industries.desc')}</p>
              <div className="flex flex-col gap-4 md:flex-row mb-10">
                <button className="bg-green-600 text-white py-2 px-2 font-bold rounded-lg border-green-600 border-2 md:flex-[1.2]">
                  {t('industries.demo')}
                </button>
            ...
            <div className="grid grid-cols-1 grid-rows-6 md:grid-cols-2 md:grid-rows-3 lg:grid-cols-3 lg:grid-rows-2 gap-4">
              {Array.from({ length: 6 }).map((_, i) => (
                <div key={i} className="flex flex-col justify-end bg-black p-8 rounded-lg h-64">
                  ...
                  <p className="descriptions text-white">{t('metrics.data')}</p>
                </div>
              ))}
            </div>
          </section>
          ...
          <section className="flex flex-col gap-14 lg:flex-row lg:justify-between p-6 md:p-16 rounded-lg bg-white mb-16">
            ...
            <div className="lg:w-1/2">
              <AccordionItem title={`1. ${t('faq.q1')}`}>
                ...
                <p className="descriptions mb-4">{t('faq.q1.what')}</p>

                <div className="flex justify-start gap-1">
                  <span>ICON</span>
                  <h3 className="title-small font-bold">Alertas Típicas:</h3>
                </div>
                <p className="descriptions mb-4">{t('faq.q1.alerts')}</p>

                <div className="flex justify-start gap-1">
                  <span>ICON</span>
                  <h3 className="title-small font-bold">Impacto:</h3>
                </div>
                <p className="descriptions mb-4">{t('faq.q1.impact')}</p>
              </AccordionItem>
          ...
          <section className="bg-transparent rounded-lg flex flex-col lg:flex-row justify-between p-16 mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div className="md:col-span-2">
                <label className="descriptions-sm mb-2 block">{t('form.name')}</label>
                <input
                  type="text"
                  name="nombre"
                  placeholder="Jon Doe"
              ...
              {/* Empresa / País */}
              <div>
                <label className="descriptions-sm mb-2 block">{t('form.company')}</label>
                <input
                  type="text"
                  name="empresa"
              ...
              <div>
                <label className="descriptions-sm mb-2 block">{t('form.country')}</label>
                <input
                  type="text"
                  name="pais"
                  placeholder="Panamá"
              ...
              {/* Email / Teléfono */}
              <div>
                <label className="descriptions-sm mb-2 block">{t('form.email')}</label>
                <input
                  type="email"
                  name="email"
              ...
              <div>
                <label className="descriptions-sm mb-2 block">{t('form.phone')}</label>
                <input
                  type="tel"
                  name="telefono"
              ...
              {/* Mensaje */}
              <div className="md:col-span-2">
                <label className="descriptions-sm mb-2 block">{t('form.message')}</label>
                <textarea
                  name="mensaje"
        ...
        <footer id="contact" className="bg-white flex flex-col lg:flex-row p-16 mb-16 gap-28 rounded-lg">
          ...
          <div className="flex gap-14">
            <div>
              <h1 className="title-tiny font-semibold">{t('footer.product')}</h1>
              ...
              <p className="descriptions">{t('footer.contact')}</p>
            </div>

            <div>
              <h1 className="title-tiny font-semibold">{t('footer.contact')}</h1>
            ...
            <div>
              <h1 className="title-tiny font-semibold">{t('footer.legal')}</h1>
              <p className="descriptions">{t('footer.terms')}</p>
              <p className="descriptions">{t('footer.privacy')}</p>
            </div>	
          </div>
        </footer>
      </div>
