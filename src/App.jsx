  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      if (featuresGridRef.current) {
        const gridKids = Array.from(featuresGridRef.current.querySelectorAll(":scope > * > *"));
      ...
      <div className="px-8 pt-8 md:px-12 md:py-12 max-width-custom mx-auto relative">
        ...
        <main ref={mainRef}>
          ...
          >
            ...
            />
            <div ref={modulesLeftRef} className="flex flex-col lg:w-1/2 gap-10">
              ...
              <AccordionItem title={t("modules.retail.title")}>
                <div className="flex flex-col justify-start gap-6">
                  ...
                  <AccordionData
                    ...
                    description={t("modules.retail.alerts.desc")}
                  />
                  <AccordionData
                    iconColor="text-green-600"
                    title={t("modules.retail.impact.title")}
                    description={t("modules.retail.impact.desc")}
                  />
                </div>
              </AccordionItem>
              ...
              <AccordionItem title={t("modules.perimeter.title")}>
                <div className="flex flex-col justify-start gap-6">
                  <AccordionData
                    ...
                    description={t("modules.perimeter.what.desc")}
                  />
                  <AccordionData
                    iconColor="text-green-600"
                    title={t("modules.perimeter.alerts.title")}
                    description={t("modules.perimeter.alerts.desc")}
                  />
                  <AccordionData
                    iconColor="text-green-600"
                    title={t("modules.perimeter.impact.title")}
                    description={t("modules.perimeter.impact.desc")}
                  />
                </div>
              </AccordionItem>
              ...
              <AccordionItem title={t("modules.loitering.title")}>
                <div className="flex flex-col justify-start gap-6">
                  <AccordionData
                    ...
                    description={t("modules.loitering.what.desc")}
                  />
                  <AccordionData
                    iconColor="text-green-600"
                    title={t("modules.loitering.alerts.title")}
                    description={t("modules.loitering.alerts.desc")}
                  />
                  <AccordionData
                    iconColor="text-green-600"
                    title={t("modules.loitering.impact.title")}
                    description={t("modules.loitering.impact.desc")}
                  />
                </div>
              </AccordionItem>
          ...
          >
            <CornerFrame hover={false} strokeColor="currentColor" className="text-neutral-500" />

            <div ref={featuresHeaderRef} className="flex flex-col box-border md:w-[443px] pb-8">
              <div className="pb-6">
                <h2 className="title-big font-semibold pb-2">{t("features.title")}</h2>
                <p className="descriptions">{t("metrics.desc")}</p>
              </div>
              <div ref={featuresButtonsRef} className="flex flex-col md:flex-row gap-4">
            ...
            <div ref={featuresGridRef} className="flex flex-col">
              <div className="flex flex-col md:flex-row">
                <CardHowItWorks title={t("features.step1")} iconSrc="assets/icon1.svg" number={1} />
                <DashedConnector className="hidden md:block w-16" />
                <div className="w-full block md:hidden">
                  <DashedConnector className="h-16" orientation="vertical" />
                </div>
                <CardHowItWorks title={t("features.step2")} iconSrc="assets/icon2.svg" number={2} />
                <DashedConnector className="hidden md:block w-16" />
                <div className="w-full block md:hidden">
                  <DashedConnector className="h-16" orientation="vertical" />
                </div>
                <CardHowItWorks title={t("features.step3")} iconSrc="assets/icon3.svg" number={3} />
              </div>
              <div className="flex flex-row gap-16">
                <div className="hidden md:block md:w-full"></div>
                <div className="hidden md:block md:w-full"></div>
                <div className="w-full flex justify-center">
                  <DashedConnector className="h-full w-16" orientation="vertical" />
                </div>
              </div>

              <div className="flex flex-col md:flex-row">
                <CardHowItWorks title={t("features.step4")} iconSrc="assets/icon4.svg" number={4} />
                <DashedConnector className="hidden md:block  w-16" reverse={true} />
                <div className="w-full block md:hidden">
                  <DashedConnector className="h-16" orientation="vertical" />
                </div>
                <CardHowItWorks title={t("features.step5")} iconSrc="assets/icon5.svg" number={5} />
                <DashedConnector className="hidden md:block  w-16" reverse={true} />
                <div className="w-full block md:hidden">
                  <DashedConnector className="h-16" orientation="vertical" />
                </div>
                <CardHowItWorks title={t("features.step6")} iconSrc="assets/icon6.svg" number={6} />
              </div>
            </div>
          </section>
          ...
          >
            <CornerFrame hover={false} strokeColor="currentColor" className="text-green-400" />
            <img
              className="absolute top-0 w-[600px] right-0 z-0"
              src="/assets/background/BG-Decoration.png"
              alt="Atelopus decoración"
            ...
            <div ref={benefitsHeaderRef} className="flex flex-col mx-6 md:ml-16 pt-6 md:pt-16 md:w-[443px] ">
              <h2 className="title-big font-semibold text-white mb-4">{t("benefits.title")}</h2>
              <p className="text-neutral-400 pb-8">{t("benefits.desc")}</p>

              <div ref={benefitsButtonsRef} className="flex flex-col md:flex-row gap-4 pb-8">
                <button className="btn-text-regular btn-green relative">
                  {t("hero.demo")}
                  <CornerFrame strokeColor="currentColor" className="text-neutral-950" />
                </button>
            ...
            >
              <CardBenefits title={t("benefits.1")} number={1} imgSrc="/assets/benefits/benefit-1.png" />
              <CardBenefits title={t("benefits.2")} number={2} imgSrc="/assets/benefits/benefit-2.png" />
              <CardBenefits title={t("benefits.3")} number={3} imgSrc="/assets/benefits/benefit-3.png" />
              <CardBenefits title={t("benefits.4")} number={4} imgSrc="/assets/benefits/benefit-4.png" />
              <CardBenefits title={t("benefits.5")} number={5} imgSrc="/assets/benefits/benefit-5.png" />
              <CardBenefits title={t("benefits.6")} number={6} imgSrc="/assets/benefits/benefit-6.png" />
              <CardBenefits title={t("benefits.7")} number={7} imgSrc="/assets/benefits/benefit-7.png" />
              <CardBenefits title={t("benefits.8")} number={8} imgSrc="/assets/benefits/benefit-8.png" />
            </div>
          </section>
          ...
          >
            <CornerFrame strokeColor="currentColor" className="text-neutral-400" />
            <div ref={versionsHeaderRef} className="flex flex-col max-w-[443px]">
              <h2 className="title-big font-semibold mb-4 text-center">{t("versions.title")}</h2>
              <p className="descriptions mb-6 text-center">{t("versions.desc")}</p>
              <div ref={versionsButtonsRef} className="flex flex-col md:flex-row gap-4 pb-8">
                <button className="btn-text-regular btn-dark relative">
                  {t("hero.demo")}
          ...
          >
            <CornerFrame strokeColor="currentColor" className="text-green-400" />
            <img
              ...
              >
                <div className="flex flex-col justify-start gap-6">
                  <AccordionData
                    ...
                    description={t("industries.retail.what.desc")}
                  />
                  <AccordionData
                    iconColor="text-green-400 currentColor"
                    titleTextColor="text-white"
                    ...
                    description={t("industries.retail.loss.desc")}
                  />
                  <AccordionData
                    iconColor="text-green-400 currentColor"
                    titleTextColor="text-white"
                    ...
                    description={t("industries.retail.safety.desc")}
                  />
                </div>
              </AccordionItem>
              ...
              >
                <div className="flex flex-col justify-start gap-6">
                  <AccordionData
                    ...
                    titleTextColor="text-white"
                    descriptionColor="text-neutral-400"
                    title={t("industries.gaming.watchlists.title")}
                    description={t("industries.gaming.watchlists.desc")}
                  />
                  <AccordionData
                    iconColor="text-green-400 currentColor"
                    titleTextColor="text-white"
                    descriptionColor="text-neutral-400"
                    title={t("industries.gaming.safeplay.title")}
                    description={t("industries.gaming.safeplay.desc")}
                  />
                  <AccordionData
                    iconColor="text-green-400 currentColor"
                    titleTextColor="text-white"
                    descriptionColor="text-neutral-400"
                    title={t("industries.gaming.compliance.title")}
                    description={t("industries.gaming.compliance.desc")}
                  />
                </div>
              </AccordionItem>
              ...
              >
                <div className="flex flex-col justify-start gap-6">
                  <AccordionData
                    ...
                    titleTextColor="text-white"
                    descriptionColor="text-neutral-400"
                    title={t("industries.residential.access.title")}
                    description={t("industries.residential.access.desc")}
                  />
                  <AccordionData
                    iconColor="text-green-400 currentColor"
                    titleTextColor="text-white"
                    descriptionColor="text-neutral-400"
                    title={t("industries.residential.perimeter.title")}
                    description={t("industries.residential.perimeter.desc")}
                  />
                  <AccordionData
                    iconColor="text-green-400 currentColor"
                    titleTextColor="text-white"
                    descriptionColor="text-neutral-400"
                    title={t("industries.residential.management.title")}
                    description={t("industries.residential.management.desc")}
                  />
                </div>
              </AccordionItem>
              ...
              >
                <div className="flex flex-col justify-start gap-6">
                  <AccordionData
                    ...
                    titleTextColor="text-white"
                    descriptionColor="text-neutral-400"
                    title={t("industries.education.safety.title")}
                    description={t("industries.education.safety.desc")}
                  />
                  <AccordionData
                    iconColor="text-green-400 currentColor"
                    titleTextColor="text-white"
                    descriptionColor="text-neutral-400"
                    title={t("industries.education.access.title")}
                    description={t("industries.education.access.desc")}
                  />
                  <AccordionData
                    iconColor="text-green-400 currentColor"
                    titleTextColor="text-white"
                    descriptionColor="text-neutral-400"
                    title={t("industries.education.response.title")}
                    description={t("industries.education.response.desc")}
                  />
                </div>
              </AccordionItem>
            </div>

            <div ref={industriesRightRef} className="flex flex-col lg:1/2">
              <h2 className="title-big text-white font-semibold mb-4">{t("industries.title")}</h2>
              <p className="descriptions text-neutral-400 mb-6">{t("industries.desc")}</p>
          ...
          {/* MÉTRICAS */}
          <section ref={metricsRef} className="flex flex-col items-center p-16 mb-16">
            <div ref={metricsHeaderRef} className="flex flex-col min-w-[443px] mb-10">
              <h2 className="title-big font-semibold mb-4 text-center">{t("metrics.title")}</h2>
              <span className="descriptions mb-6 text-center">{t("metrics.desc")}</span>
              <div ref={metricsButtonsRef} className="flex flex-col md:flex-row gap-4">
                <button className="btn-text-regular btn-dark relative">
                  {t("hero.demo")}
                  <CornerFrame className="text-green-500" strokeColor="currentColor" />
                </button>
            ...
            >
              <CardMetric title={t("metrics.1.title")} description={t("metrics.1.desc")} />
              <CardMetric title={t("metrics.2.title")} description={t("metrics.2.desc")} />
              <CardMetric title={t("metrics.3.title")} description={t("metrics.3.desc")} />
              <CardMetric title={t("metrics.4.title")} description={t("metrics.4.desc")} />
              <CardMetric title={t("metrics.5.title")} description={t("metrics.5.desc")} />
              <CardMetric title={t("metrics.6.title")} description={t("metrics.6.desc")} />
            </div>
          </section>
          ...
          >
            <CornerFrame hover={false} strokeColor="currentColor" className="text-green-500" />
            <div ref={faqLeftRef} className="flex flex-col lg:w-1/2 gap-10">
          ...
          <section ref={ctaRef} className="bg-black rounded-lg mb-16 flex justify-center p-16 relative">
            ...
            <div className="flex flex-col max-w-[443px]">
              <h2 className="title-big text-white font-semibold mb-14 text-center">{t("cta.title")}</h2>
          ...
          >
            <CornerFrame hover={false} strokeColor="currentColor" className="text-neutral-600" />
            <div className=" max-w-2xl w-full" ref={formHeaderRef}>
              <div className="mb-8">
                <h1 className="title-big font-bold mb-2">{t("form.title")}</h1>
