...
// 			const target =
// 				u >= 0 ? speed + u * maxBoostDown : speed + u * maxBoostUp;
...
// 					<img
// 						src="/animation-dark/orbit-01.webp"
// 						alt=""
// 						decoding="async"
// 						loading="lazy"
// 					/>
...
// 					<img
// 						src="/animation-dark/orbit-02.webp"
// 						alt=""
// 						decoding="async"
// 						loading="lazy"
// 					/>
...
// 					<img
// 						src="/animation-dark/orbit-03.webp"
// 						alt=""
// 						decoding="async"
// 						loading="lazy"
// 					/>
...
// 					<img
// 						src="/animation-dark/orbit-04.webp"
// 						alt=""
// 						decoding="async"
// 						loading="lazy"
// 					/>
...
/**
 * OrbitAnimation.jsx
 * - Soporta variantes "dark" (default) y "light"
 * - Dark usa assets en /animation-dark/*.webp (core.svg/core-blur.svg + webp orbits)
 * - Light usa assets en /animation-light/*.svg (todo en SVG)
 */
...
export default function OrbitAnimation({
  ...
  pauseOnHover = false,
  scale = 1,
  variant = "dark", // 👈 nueva prop
}) {
  const [d1, d2, d3, d4] = durations;

  // paths base
  const basePath = variant === "light" ? "/animation-light" : "/animation-dark";

  // extensiones (en light todo es .svg, en dark orbits son .webp)
  const orbitExt = variant === "light" ? "svg" : "webp";
  ...
  return (
    ...
    >
      <div className={`oa-stage ${innerClass}`}>
        {/* Núcleo (en dark mostramos blur + core, en light solo core.svg) */}
        <div className="oa-layer oa-core oa-o1 oa-spin oa-ccw">
          {variant === "dark" && (
            <img
              src={`${basePath}/core-blur.svg`}
              alt=""
              decoding="async"
              fetchpriority="low"
              loading="eager"
          ...
          <img
            src={`${basePath}/core.${variant === "light" ? "svg" : "svg"}`}
            alt=""
            decoding="async"
            fetchpriority="low"
            loading="eager"
        ...
        <div className="oa-layer oa-orbit oa-o1 oa-spin oa-cw">
          <img
            src={`${basePath}/orbit-01.${orbitExt}`}
            alt=""
            decoding="async"
            loading="lazy"
          />
        ...
        <div className="oa-layer oa-orbit oa-o2 oa-spin oa-ccw">
          <img
            src={`${basePath}/orbit-02.${orbitExt}`}
            alt=""
            decoding="async"
            loading="lazy"
          />
        ...
        <div className="oa-layer oa-orbit oa-o3 oa-spin oa-cw">
          <img
            src={`${basePath}/orbit-03.${orbitExt}`}
            alt=""
            decoding="async"
            loading="lazy"
          />
        ...
        <div className="oa-layer oa-orbit oa-o4 oa-spin oa-ccw">
          <img
            src={`${basePath}/orbit-04.${orbitExt}`}
            alt=""
            decoding="async"
            loading="lazy"
          />
